...
export class BootScene extends Phaser.Scene {
  ...
  createProjectileSprites() {
    ...
    // Rocket / buscapé — foguete de festa junina (apontando para cima; rotacionado no render)
    makePixelTexture(
      this,
      'proj_rocket',
      [
  ...
  createSpellIcons() {
    ...
    const icons = {
      ...
      water_orb: {
        ...
        palette: { B: 0x1a5276, W: 0x5dade2, C: 0x85c1e9, D: 0xd6eaf8 },
      },
      vine_spike: {
        rows: [
          '................',
      ...
      apocalypse: {
        ...
        palette: { Y: 0xffee66, R: 0xff2200, O: 0xff6622, D: 0xffaa44 },
      },
      time_freeze: {
        rows: [
          '................',
  ...
  createOreSprites() {
    const ores = {
      ore_copper: {
        ...
        palette: { B: 0x7a5a3a, D: 0x9a7a5a, C: 0xe87438 },
      },
      ore_iron: {
        rows: [
          '................',
        ...
        palette: { G: 0x5a5a68, S: 0x7a7a88, I: 0x8c7a6b },
      },
      ore_silver: {
        rows: [
          '................',
        ...
        palette: { H: 0x606978, L: 0x9099b0, S: 0xc0c8d4 },
      },
      ore_gold: {
        rows: [
          '................',
        ...
        palette: { B: 0x8a6a30, Y: 0xc89828, G: 0xe8c048 },
      },
      ore_diamond: {
        rows: [
          '................',
        ...
        palette: { G: 0x507888, S: 0x70a0b0, D: 0x64d8e8 },
      },
      ore_emerald: {
        rows: [
          '................',
        ...
        palette: { G: 0x386848, S: 0x508860, E: 0x40c860 },
      },
      ore_ruby: {
        rows: [
          '................',
        ...
        palette: { D: 0x6a2828, R: 0xaa3040, d: 0xe04050 },
      },
      ore_sapphire: {
        rows: [
          '................',
        ...
        palette: { B: 0x203868, S: 0x284888, N: 0x3068e8 },
      },
      ore_quartz: {
        rows: [
          '................',
        ...
        palette: { G: 0x786880, S: 0x9888a0, Q: 0xe8d0e0 },
      },
      ore_obsidian: {
        rows: [
          '................',
        ...
        palette: { B: 0x1a1018, D: 0x281828, L: 0x301828 },
      },
      ore_mythril: {
        rows: [
          '................',
        ...
        palette: { B: 0x406878, S: 0x508898, M: 0x60c0d8 },
      },
      ore_orichalcum: {
        rows: [
          '................',
        ...
        palette: { B: 0x7a5030, R: 0xaa7030, O: 0xe8a030 },
      },
      ore_moonstone: {
        rows: [
          '................',
        ...
        palette: { G: 0x485878, S: 0x6078a0, M: 0xa0b8ff },
      },
      ore_sunstone: {
        rows: [
          '................',
        ...
        palette: { B: 0x8a6830, Y: 0xba9830, S: 0xffcc50 },
      },
      ore_shadow: {
        rows: [
          '................',
        ...
        palette: { B: 0x181028, D: 0x282040, S: 0x482868 },
      },
      ore_crystal: {
        rows: [
          '................',
        ...
        palette: { G: 0x488868, S: 0x68b888, C: 0xb0ffd8 },
      },
      ore_coral: {
        rows: [
          '................',
        ...
        palette: { B: 0x7a4848, D: 0xa86858, C: 0xe87080 },
      },
      ore_amber: {
        rows: [
          '................',
        ...
        palette: { B: 0x7a6030, Y: 0xaa8030, A: 0xf0a040, O: 0xf8c050 },
      },
      ore_jade: {
        rows: [
          '................',
        ...
        palette: { G: 0x387850, S: 0x509870, J: 0x40a870 },
      },
      ore_onyx: {
        rows: [
          '................',
        ...
        palette: { B: 0x141420, D: 0x1c1c28, O: 0x202028 },
      },
    };

    for (const [key, def] of Object.entries(ores)) {
      if (this.textures.exists(key)) continue;
      makePixelTexture(this, key, def.rows, def.palette, 2);
    }
  }
  ...
  createExpandedArenaFloors() {
    const floors = [
      ...
      ['arena_crystal_cave', [0x1a1428, 0x2a2038, 0x0e0a18, 0x080610, 0x4a3060, 0x181020, 0x8e44ad, 0xc39bd3, 0x5b2c6f, 0x040208], [{ x: 22, y: 24, r: 6, c: 0x8e44ad }, { x: 48, y: 42, r: 5, c: 0xc39bd3 }]],
      ['arena_bat_cave', [0x1a1814, 0x2a2820, 0x10100c, 0x080806, 0x3a3830, 0x1e1c18, 0x4a4840, 0x2c2a24, 0x5a5850, 0x040402], [{ x: 28, y: 22, r: 5, c: 0x2a2820 }, { x: 14, y: 46, r: 6, c: 0x10100c }]],
      ['arena_vampire_castle', [0x2a1014, 0x3a181c, 0x1a080c, 0x0e0406, 0x4a2028, 0x241014, 0x7b241c, 0x922b21, 0x5a1820, 0x080204], [{ x: 20, y: 28, r: 6, c: 0x7b241c }, { x: 46, y: 18, r: 5, c: 0x3a181c }]],
      ['arena_throne_hall', [0x3a1418, 0x5a2028, 0x24100c, 0x140808, 0x6a2830, 0x2e1418, 0xa93226, 0xc0392b, 0x8a3028, 0x0c0404], [{ x: 24, y: 20, r: 7, c: 0xa93226 }, { x: 48, y: 44, r: 5, c: 0x5a2028 }]],
      ['arena_crypt', [0x3a3834, 0x4a4840, 0x2a2824, 0x1a1814, 0x5a5850, 0x343230, 0x6a6860, 0x7b241c, 0x787468, 0x121010], [{ x: 22, y: 30, r: 5, c: 0x6a6860 }, { x: 46, y: 16, r: 4, c: 0x7b241c }]],
    ];
  ...
  registerCatalogMonsterSprites() {
    ...
    const entries = [
      ...
      // Expansão 7 +18
      ['glass_wisp', 'winged', 0xa8d8ea, 0x6ba3b8, 0xd4eef7, 0xffffff, 0x4a7a8a],
      ['peat_boar', 'beast', 0x5d4037, 0x3e2723, 0x8d6e63, 0xffcc66, 0x2c1810],
      ['rust_golem', 'bulk', 0xb7410e, 0x7a2e0a, 0xd4734a, 0xffee88, 0x4a1a05],
      ['lantern_moth', 'winged', 0xffe082, 0xc9a227, 0xfff3c4, 0xfff8e1, 0x8a6d1a],
      ['brine_eel', 'serpent', 0x26a69a, 0x147368, 0x4db6ac, 0xb2dfdb, 0x0d4f47],
      ['spore_toad', 'beast', 0x7cb342, 0x558b2f, 0xaed581, 0xffff66, 0x33691e],
      ['flint_imp', 'humanoid', 0x8d6e63, 0x5d4037, 0xbcaaa4, 0xff7043, 0x3e2723],
      ['hail_raven', 'winged', 0xb0bec5, 0x78909c, 0xcfd8dc, 0xe3f2fd, 0x455a64],
      ['root_hound', 'beast', 0x6d4c41, 0x4e342e, 0xa1887f, 0xffcc80, 0x3e2723],
      ['mirror_sprite', 'winged', 0xce93d8, 0x8e24aa, 0xe1bee7, 0xffffff, 0x6a1b9a],
      ['kiln_scarab', 'beast', 0xe65100, 0xbf360c, 0xff8a65, 0xffee66, 0x6d1b00],
      ['void_newt', 'serpent', 0x4a148c, 0x2e0854, 0x7b1fa2, 0xea80fc, 0x1a0033],
      ['thunder_ibex', 'beast', 0x5c6bc0, 0x3949ab, 0x9fa8da, 0xffee88, 0x283593],
      ['coral_medusa', 'serpent', 0xe91e63, 0xad1457, 0xf06292, 0xffeeff, 0x880e4f],
      ['ember_knight', 'humanoid', 0xbf360c, 0x7f0000, 0xff7043, 0xffee66, 0x4a0000],
      ['frost_colossus', 'bulk', 0x81d4fa, 0x4fc3f7, 0xb3e5fc, 0xffffff, 0x0277bd],
      ['nightbloom_hydra', 'serpent', 0x6a1b9a, 0x4a148c, 0xab47bc, 0xea80fc, 0x2e0854],
      ['starfall_oracle', 'humanoid', 0xffd54f, 0xffa000, 0xffecb3, 0xffffff, 0xc17900],
      // Expansão 8 +300
