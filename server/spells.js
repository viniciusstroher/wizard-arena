...
export const SPELLS = {
  ...
  water_orb: {
    ...
    name: 'Orbe Aquático',
    description:
      'Projétil de água. Dispara sozinho enquanto o slot estiver selecionado. Causa dano e reduz velocidade por 4s.',
    type: 'basic',
    playerUsable: true,
    cooldown: 0.48,
    manaCost: 0,
  ...
  vine_spike: {
    ...
    description:
      'Espinho de vinha. Dispara sozinho enquanto o slot estiver selecionado. Causa dano e aplica veneno (3 de dano/s por 4s).',
    type: 'basic',
    playerUsable: true,
    cooldown: 0.55,
    manaCost: 0,
  ...
  // ─── Expansão 8 — exclusivas de monstro ─────────────────
  ember_bolt: {
    id: 'ember_bolt',
    name: 'Seta de Brasa',
...
export const ULTIMATES = {
  apocalypse: {
    id: 'apocalypse',
    name: 'Apocalipse',
    description: 'Pentagrama na área e explosão de fogo de baixo para cima. Ultimate — autocast.',
    type: 'ultimate',
    playerUsable: true,
